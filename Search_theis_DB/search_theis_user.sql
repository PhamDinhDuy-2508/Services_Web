...
CREATE TABLE `user` (
  ...
  `Home_number` varchar(256) DEFAULT NULL,
...
INSERT INTO `user` VALUES (NULL,NULL,'duydinh258138@gmail.com',NULL,NULL,NULL,NULL,NULL,1,NULL,'hiepsirua75','25082000',NULL,NULL,NULL,NULL,'');
