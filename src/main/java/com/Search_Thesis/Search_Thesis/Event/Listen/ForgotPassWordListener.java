...
public class ForgotPassWordListener {
        ...
        public void ForgotPassword(SendEmailEvent sendEmail_event) throws MessagingException, UnsupportedEncodingException {
            ...
            if(user != null) {
                String resetPasswordLink = com.Search_Thesis.Search_Thesis.Event.Listen.Utility.getSiteURL(sendEmail_event.getRequest()) + "/reset_pass?token=" + sendEmail_event.getToken();
